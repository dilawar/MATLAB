...
for animal = 1:nAnimals
    ...
    for session = 1:nSessions
        ...
        %session = 1;
        dataset = [mouse '_SessionType' num2str(sessionType) '_Session' num2str(session+sessionOffset)];
        ...
        if aoc == 1
            ...
            title([mouse ' ST' num2str(sessionType) ' S' num2str(session+sessionOffset)],...
                'FontSize',fontSize,...
                'FontWeight','bold');
            xlabel('Trials',...
                'FontSize',fontSize,...
        ...
        if rawPeaks == 1
            ...
            if strcmp(mySessionType,'TEC')
                ...
                title([mouse ' ST' num2str(sessionType) ' S' num2str(session+sessionOffset) ' (AU)'],...
                    'FontSize',fontSize+2,...
                    'FontWeight','bold');
                xlabel('Time/10 ms',...
                    'FontSize',fontSize,...
                ...
                title(['Session' num2str(session+sessionOffset)],...
                    'FontSize',fontSize+2,...
                    'FontWeight','bold');
            ...
            if saveFigures == 1
                ...
                if strcmp(mySessionType,'TEC')
                    print(['/Users/ananth/Desktop/Figures/Mouse' mouse '/crurRatio_' mouse ...
                        '_' mySessionType ...
                        '_Session' num2str(session+sessionOffset)],...
                        '-djpeg');
                else
    ...
    if rawPeaks == 1
        ...
        if probe == 1
            ...
            title(['Mouse' mouse ...
                ...
                'FontSize',fontSize,...
                'FontWeight','bold');
            xlabel(['Session' num2str(session+sessionOffset)],...
                'FontSize',fontSize,...
                'FontWeight','bold');
            %xt = get(gca, 'XTick');
            set(gca, 'XTick', []);
