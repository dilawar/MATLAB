...
while 1
    ...
    for trialNum = 1:totalTrials
        ...
        rawData_size(trialNum) = size(csvread(filename, 4, 0), 1);
    end
    ...
    if saveData == 1
        ...
        if findSignificantBlinks == 1
            ...
            %CS-
            csvwrite([saveFolder, dataset, '_blinks_csMinus_fullTrial.csv'], blinks_csMinus_fullTrial);
        ...
        if findSignificantBlinks == 1
            ...
            %CS-
            save([saveFolder, dataset, '_blinks_csMinus_fullTrial'], 'blinks_csMinus_fullTrial');
